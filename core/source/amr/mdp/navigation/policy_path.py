...
def get_locomotion_policy_path() -> str:
    ...
    possible_base_log_dirs = [
        ...
        "/workspace/core/logs/rsl_rl/amr_locomotion",
        "/workspace/logs/rsl_rl/amr_locomotion",
    ]

    for base_log_dir in possible_base_log_dirs:
    ...
    fallback_path = "/workspace/core/logs/rsl_rl/amr_locomotion/pretrained/policy.pt"
