...
from isaaclab_tasks.manager_based.manipulation.lift_allegro.lift2_env_allegro_cfg import BaseLiftEnvCfg
...
@configclass
class CobotUR5eCylinderLiftEnvCfg(BaseLiftEnvCfg):
...
@configclass
class CobotUR5eCylinderLiftEnvCfg_PLAY(CobotUR5eCylinderLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
