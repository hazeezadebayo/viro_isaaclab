...
from core.source.anymal.tasks.anymal_locomotion_flat_env_cfg import AnymalLocomotionFlatEnvCfg
from core.source.anymal.tasks.anymal_locomotion_rough_env_cfg import MySceneCfg as LocomotionSceneCfg
import core.source.anymal.mdp.navigation.commands as obstacle_cmd


def get_locomotion_policy_path(flat: bool = True) -> str:
...
LOW_LEVEL_ENV_CFG = AnymalLocomotionFlatEnvCfg()
_RESOLVED_POLICY_PATH = get_locomotion_policy_path(flat=True)
...
@configclass
class AnymalNavigationFlatEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the ANYmal-C flat terrain navigation environment."""
...
@configclass
class AnymalNavigationEnvCfg_PLAY(AnymalNavigationFlatEnvCfg):
