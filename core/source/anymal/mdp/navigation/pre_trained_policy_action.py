...
class PreTrainedPolicyAction(ActionTerm):
    ...
    def __init__(self, cfg: PreTrainedPolicyActionCfg, env: ManagerBasedRLEnv) -> None:
        ...
        if hasattr(cfg.low_level_observations, "pose_command"):
            cfg.low_level_observations.pose_command.func = lambda dummy_env: self._raw_actions
            cfg.low_level_observations.pose_command.params = dict()
        elif hasattr(cfg.low_level_observations, "velocity_commands"):
